    ...
    var server = net.createServer(function (socket) {
        ...
        socket.on('data', function (msg) {
            ...
            if (message.indexOf('addid') !== -1) {
				self.logger.info('Received UPNP Command to add songs to playback, stopping normal operations')
        ...
        serviceSocket.connect(parseInt(mpd_port), upnp_endpoint, function () {
